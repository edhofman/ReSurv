...
```{r instancepackage eval=FALSE, include=FALSE}
library(ReSurv)
library(reticulate)
...
In this vignette we show a pipeline for predicting individual claim counts using the `ReSurv` pacakge. This vignette contains the code to replicate our 
